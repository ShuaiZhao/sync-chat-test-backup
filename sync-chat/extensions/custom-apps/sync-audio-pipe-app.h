 ...
 */
class SyncAudioApp : public ndn::App
{
public:
  // register NS-3 type "SyncAudioApp"
  static TypeId
  GetTypeId ();
...
private:
  ...
  uint32_t 			m_lastAudioContentSeq;		// keep track of last seq number of unfinished audio content
  uint32_t 			m_audioContentSeq;		///< @brief currently sequence of generated audio content
  uint32_t				m_audioContentSize;		///< @brief the size of the audio content generated
